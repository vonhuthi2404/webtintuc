<div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="admin/theloai/list"><i class="fa fa-dashboard fa-fw"></i>Dashboard</a>
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Thể Loại<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="admin/theloai/list">Danh Sách Thể Loại</a>
                                </li>
                                <li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="admin/loaitin/list">Danh Sách Loại Tin</a>
                                </li>
                                <li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="admin/tintuc/list">Danh Sách Tin Tức</a>
                                </li>
                                <li>
                                    <a href="admin/tintuc/add">Thêm Tin Tức</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="admin/banner/list">Danh Sách Banner</a>
                                </li>
                                <li>
                                    <a href="admin/banner/add">Thêm Banner</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                         ...
                         <li>
                            <a href="admin/contact"><i class="fa fa-users fa-fw"></i> Danh Sách Liên Hệ</a>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                    </ul>
